...
const messages_es = {
  ...
  checkoutProcessForm: {
    ...
    payment_method: {
      ...
      considerations_mercado_pago_note_1:
        'Emitiremos la factura a <bold>Consumidor Final</bold> en <bold>pesos argentinos</bold>, según el tipo de cambio vendedor del Banco de la Nación Argentina el día de emisión de la misma.',
  ...
  checkoutProcessSuccess: {
    ...
    discount_quarterly: '3 meses',
    discount_yearly: '12 meses',
    mercado_pago_check_email_with_invoice_message: 'Dentro de las próximas 48-hs hábiles recibirás un mail con la confirmación de pago y podrás empezar a disfrutar de tu nuevo plan.',
    mercado_pago_contact_support: 'Si tienes dudas respecto al estado del pago puedes escribirnos a <Bold>administracion@fromdoppler.com</Bold>',
    ...
    mercado_pago_warning_message: 'Estamos procesando tu pago a través de Mercado Pago, esto puede demorar hasta 48-hs hábiles.',
    ...
    transfer_send_the_receipt_message: 'Envía el comprobante de pago a billing@fromdoppler.com para que podamos activar tu nuevo Plan.',
