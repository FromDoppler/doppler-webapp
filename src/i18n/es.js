  ...
  buy_process: {
    ...
    new_plan_selection: {
      ...
      included_features: {
        ...
        item_2_description: 'Genera ideas con IA para crear asuntos, contenidos y piezas más efectivas en menos tiempo.',
        item_2_title: 'Optimiza tus tiempos con IA',
        item_3_description: 'Segmenta tus audiencias y personaliza cada mensaje según intereses, comportamiento y etapa del cliente.',
        item_3_title: 'Habla a cada cliente como si fuera único',
        item_4_description: 'Coordina campañas en distintos canales para mantener conversaciones consistentes con tu audiencia.',
        item_4_title: 'Llega a tus clientes donde están',
        item_5_description: 'Accede a reportes detallados para medir rendimiento, detectar oportunidades y tomar mejores decisiones.',
        item_5_title: 'Mide y mejora cada acción',
        item_6_description: 'Integra formularios, sitios y analítica para potenciar conversiones y hacer crecer tu estrategia.',
        item_6_title: 'Potencia tus resultados con integraciones',
        modal_title: 'Funcionalidades y Soluciones',
        see_more: 'Ver más funcionalidades',
        subtitle: 'Todos nuestros planes incluyen todas nuestras funcionalidades. ¿Conoces todo lo que puedes hacer con Doppler?',
        title: 'Accede a todas las funcionalidades desde el Plan básico',
      },
      month_period: 'mes',
