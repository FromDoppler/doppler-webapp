...
export default {
  ...
  exclusive_form: {
    ...
    breadcrumb: 'Planes',
    breadcrumb_url: `${urlBuyMonthly}`,
    dedicated_ip: 'IP Dedicada',
    demo: 'Solicitar una demo',
    description: 'Características especiales pensados para los usuarios más exigentes. Desarrollo de funcionalidades a medida, atención personalizada y más..',
    design: 'Diseño, maquetacion y envio de Emails',
    development_features: 'Desarrollo de Funcionalidades personalizadas',
    features_for_you: 'Funcionalidades a tu medida',
    form_features: 'Selecciona las características de las que te interesaría saber más:',
    form_legend: 'Completa el siguiente formulario de planes',
    form_title: 'Completa el siguiente formulario y te contactaremos a la brevedad',
