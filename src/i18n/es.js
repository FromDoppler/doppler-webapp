...
const messages_es = {
  ...
  chat_selection: {
    ...
    plan_benefits: {
      ...
      facebook_messenger_chat_message: 'Chatbot en Facebook Messenger',
      ...
      instagram_chat_message: 'Chatbot en Instagram',
      ...
      website_chat_message: 'Chatbot en Sitio Web',
      whatsapp_business_api_chat_message: 'Chatbot en WhatsApp',
...
Encontrarás un Email con los pasos a seguir.`,
  ...
  my_plan: {
    addons: {
      ...
      push_notification: {
        description: 'Mantén la comunicación con tus clientes enviando mensajes cortos con contenido promocional o informativo.',
        month_legend: '*Por mes',
        plans_from_legend: 'Planes desde',
