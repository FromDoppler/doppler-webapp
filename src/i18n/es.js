...
const messages_es = {
  ...
  checkoutProcessForm: {
    ...
    purchase_summary: {
      ...
      explanatory_legend: 'La renovación es automática y puedes cancelarla cuando quieras. El precio del Plan no incluye impuestos.',
      ...
      promocode_legend: 'Ingresar un cupón de promoción',
