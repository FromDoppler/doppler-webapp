...
const messages_es = {
  addons: {
    carousel: {
      slice_1_button_text: `Empieza ahora`,
      ...
      slice_2_link_text: `NO QUIERO ESTE BENEFICIO`,
      slice_2_title: `Potencia tus ventas con Landing Pages optimizadas`,
      slice_3_button_text: `Empieza ahora`,
      ...
      slice_3_link_text: `NO QUIERO ESTE BENEFICIO`,
      slice_3_title: `Mejora la experiencia de compra con Doppler OnSite`,
      slice_4_button_text: `Empieza ahora`,
...
other {}}}}}}}}}}
  ...
  buy_process: {
    ...
    new_plan_selection: {
      addons_section: {
        ...
        subtitle: 'Luego de adquirir tu Plan puedes acceder a diferentes Add-Ons que se ajusten con las necesidades de tu empresa.',
        title: 'Explora nuestros Add-ons para potenciar tu Plan',
      },
      buy_credits: 'Compra ahora',
      choose_plan: 'Contrata tu Plan ahora',
      contact_advisor_cta: 'Contacta con nuestro equipo',
      contacts_current_plan_warning_message: 'No puedes seleccionar este Plan porque es el que posees actualmente.',
      contacts_downgrade_warning_message: '<bold>¿Necesitas disminuir los contactos?</bold>{br}Escríbenos y te ayudamos con el cambio.',
      ...
      credits_label: '¿Cuántos Créditos necesitas?',
      credits_option: '{credits}',
      credits_plan_description:
        'Una alternativa flexible si no quieres comprometerte con una suscripción mensual porque haces envíos más esporádicos. Los Créditos no vencen, se acumulan y bajan de precio cuantos más compres.',
      credits_plan_title: 'Compra Créditos y úsalos cuando quieras',
      credits_price_per_credit: `Precio unitario US$${formattedNumberPlaceholder}`,
      credits_promocode_savings_text: 'Ahorras {percentage}% en esta compra',
      custom_price_value: 'A medida*',
      emails_downgrade_warning_message: '<bold>¿Necesitas reducir tus Envíos?</bold>{br}Escríbenos y te ayudamos con el cambio.',
      emails_extra_email_price: 'Costo por email excedente US$ {price}',
      emails_label: 'Cuantos Envíos necesitas?',
      emails_more_than_10m_info_message: '<bold>¿Necesitas más Envíos?</bold>{br}Escríbenos y diseñamos un Plan a tu medida.',
      ...
      included_features: {
        item_1_description: 'Crea y envía Campañas profesionales a toda tu base de Contactos, sin conocimientos en HTML ni diseño.',
        item_1_title: 'Email Marketing',
        item_2_description: 'Envía el mensaje correcto, al Contacto indicado, en el momento exacto, de forma completamente automática.',
        item_2_title: 'Automation Marketing',
        item_3_description: 'Activa automatizaciones listas para usar y empieza a comunicarte sin configurar desde cero.',
        item_3_title: 'Flujos Pre-diseñados',
        item_4_description: 'Genera el contenido de tus Campañas con Inteligencia Artificial en segundos, sin bloqueo creativo ni tiempo perdido.',
        item_4_title: 'Marketing impulsado con IA',
        item_5_description: 'Agrupa tus Contactos según sus intereses y comportamientos para llegar a tus clientes potenciales.',
        ...
        modal_sections: {
          automation_marketing: {
            ...
            description_2: 'Activa automatizaciones listas para usar y empieza a comunicarte sin configurar desde cero.',
            description_3: 'Combina Email, SMS y Notificaciones Push desde una sola plataforma, de forma automática.',
            description_4: 'Recupera ventas perdidas con recordatorios automáticos a Contactos que no completaron su compra.',
            name_1: 'Flujos Automatizados',
            name_2: 'Flujos Pre-diseñados',
            name_3: 'Campañas Multicanal',
            name_4: 'Carrito Abandonado',
            title: 'Automation Marketing',
          },
          email_marketing_ai: {
            description_1: 'Crea el contenido de tus Emails en segundos: títulos, tono, gramática y mucho más.',
            description_2: 'Crea líneas de Asunto optimizadas por IA para aumentar tu Tasa de Apertura.',
            description_3: 'La IA sugiere el momento exacto para enviar cada Email maximizando tu Tasa de Apertura.',
            description_4: 'Prueba dos versiones de tu Campaña y envía automáticamente la que mejor funcione.',
            description_5: 'Crea Emails impactantes desde diseños atractivos.',
            name_1: 'Generación de Contenido',
            name_2: 'Asuntos Efectivos',
            name_3: 'Envío Inteligente',
            name_4: 'Test A/B',
            name_5: 'Plantillas profesionales',
            title: 'Email Marketing impulsado con IA',
          },
          reports_analytics: {
            description_1: 'Identifica qué Campañas funcionan mejor y detecta oportunidades de optimización en tiempo real.',
            description_2: 'Toma decisiones respaldadas en datos: Tasa de Apertura, Tasa de Clics y más.',
            description_3: 'Monitorea rebotes, bajas e inactividad para mantener tus Listas saludables y mejorar la entrega.',
            description_4: 'Comprende el comportamiento de los Contactos y toma decisiones basadas en datos reales.',
            name_1: 'Rendimiento de Campañas',
            name_2: 'Análisis de KPIs Clave',
            name_3: 'Mantenimiento de Base de Datos',
            name_4: 'Tendencias de Comportamiento',
            title: 'Reportes y Analítica',
          },
          segmentation_advanced: {
            description_1: 'Asigna una puntuación automática a cada Contacto según su interacción con contenidos personalizados.',
            description_2: 'Adapta el contenido de cada comunicación según la información e intereses de cada Contacto.',
            description_3: 'Usa datos específicos de tus Contactos para crear Segmentos a medida.',
            name_1: 'Puntuación de Contactos',
            name_2: 'Personalización Dinámica',
            name_3: 'Campos Personalizados',
      ...
      more_than_100k_info_message: '<bold>¿Más de 100K Contactos?</bold>{br}El Plan Envíos es para ti: Contactos ilimitados, menor costo por Envío y personalizado a tu medida.',
      payment_period_half_yearly: 'semestral',
      payment_period_monthly: 'mensual',
      payment_period_quarterly: 'trimestral',
      payment_period_yearly: 'anual',
      ...
      sticky_custom_title: 'Plan Envios Personalizado',
      ...
      subscription_label: 'Frecuencia de pago',
      ...
      tailored_plan_disclaimer: '*Nuestro equipo te brindará información{br}y precios del Plan más conveniente.',
    ...
    plan_selection: {
      ...
      plan_type_monthly_deliveries_selector: '¿Cuántos envíos deseas en tu plan?',
      plan_type_prepaid_info: 'Envía Emails a partir de Créditos acumulables y sin vencimiento. ',
      plan_type_prepaid_label: 'Créditos',
      plan_type_prepaid_selector: '¿Cuántos Créditos deseas agregar a tu plan?',
      ...
      plan_type_subscribers_selector: '¿Cuántos contactos deseas en tu Plan?',
      promotion_all_plans_message: 'Con el código promocional tienes un descuento de <bold>{discount}%</bold> para todos los <bold>Planes de Email Marketing</bold>.',
      promotion_one_plan_message: 'Con el código promocional tienes un descuento de <bold>{discount}%</bold> para el <bold>Plan Email Marketing de {quantity} {planType}</bold>.',
    },
    plan_to_pay: `Total del Plan:`,
    promocode: {
      apply_btn: `Aplicar`,
    ...
    shopping_cart: {
      ...
      next_invoices_estimate: 'El valor de las "Próximas facturas" es estimativo y varia según la cotización del dólar al momento de la emisión.',
      price_without_taxes: `*El precio no incluye impuestos.`,
      promotional_code: `¿Tienes un código promocional?`,
      renewal_description: `La suscripción se renueva automáticamente y puedes cancelarla cuando lo desees.`,
      save_percentage: `Ahorro {percentage}`,
      title: `Resumen de compra`,
    },
    stepper: {
      conversation_plan_step: 'Plan Conversaciones',
      eco_ai_plan_step: 'Plan Eco IA',
      email_marketing_plan_step: 'Selección de Plan',
  ...
  chat_selection: {
    ...
    plan_benefits: {
      ...
      whatsapp_business_api_chat_message: 'Chat en WhatsApp',
  ...
  checkoutProcessForm: {
    ...
    purchase_summary: {
      ...
      promocode_can_not_apply_error_all_plan_item_message: `● Planes de Marketing por <bold>{planType, select, 4 {Contactos} other {{planType, select, 3 {Créditos} other {Envíos}}}}</bold>.`,
      promocode_can_not_apply_error_message: `<bold>Este código de descuento aplica únicamente a:</bold>`,
      promocode_can_not_apply_error_plan_item_message: `● Plan de Marketing de <bold>{quantity} {planType, select, 4 {Contactos} other {{planType, select, 3 {Créditos} other {Envíos}}}}</bold>.`,
      promocode_error_message: 'Código inválido',
      promocode_expired_error_message: 'Código expirado',
      promocode_header: '¿Tienes un código de descuento?',
      promocode_label: '¿Tienes un código de descuento?',
  ...
  checkoutProcessSuccess: {
    ...
    transfer_bank_copied_message: 'Copiado',
    transfer_bank_copy_button: 'Copiar {label}',
    ...
    transfer_explore_message: 'Mientras tanto, te invitamos a continuar explorando tu cuenta...',
    transfer_pay_the_invoice_message: 'Realiza el pago.',
    transfer_purchase_finished_title: 'Tu factura está en camino',
    transfer_send_the_receipt_message: 'Una vez que realices el pago envíanos el comprobante a <Link>billing@fromdoppler.com</Link> para poder identificarlo y activar tu nuevo Plan.',
    transfer_send_the_receipt_not_upgrade_pending_message: 'Una vez realizado el pago, envíanos el comprobante a <Link>billing@fromdoppler.com</Link> y te confirmamos por mail cuando esté todo listo.',
    transfer_send_the_receipt_with_link_message: 'Envía el comprobante de pago a <Link>billing@fromdoppler.com</Link> para que podamos activar tu nuevo Plan.',
    ...
    transfer_title: 'Completa los pasos para finalizar la compra.',
    transfer_upgrade_title: '¡Tu nuevo Plan ya está activo!',
    transfer_upgrade_warning_message: 'Completa el pago para mantenerlo y seguir disfrutando de todos sus beneficios.',
  ...
  collaborators: {
    ...
    search: {
      ...
      placeholder: 'Buscar por nombre o email de Colaborador',
    },
...
<Paragraph><Bold><Link>Configura DKIM, SPF y DMARC</Link></Bold> para que tus contactos reciban tus envíos exitosamente.</Paragraph>
    ...
    learn_with_doppler_posts: {
      post_1: {
        description: 'Regístrate gratis al evento más grande de Marketing Digital de Latam.\nTe esperamos del 29 de septiembre al 1 de octubre.',
  ...
  eco_ai_selection: {
    eco_ai_plan_info: {
      legend: 'Chatea con Eco IA, tu asistente de Marketing con Inteligencia Artificial. Analizará tu cuenta, detectará oportunidades y te guíará paso a paso para sacarle el máximo provecho a tu estrategia en Doppler.',
      section_1: {
        legend: 'Eco IA revisará tu cuenta y te propondrá mejoras rápidas y concretas para potenciar tus resultados hoy mismo.',
        title: 'OPTIMIZA TU ESTRATEGIA',
      },
      section_2: {
        legend: 'Un solo plan, sin límites. Accedé a todas las funciones de Eco por US$ 49,00/mes.',
        title: 'ACCESO COMPLETO A ECO IA',
      },
    },
...
Encontrarás un Email con los pasos a seguir.`,
  ...
  landing_selection: {
    ...
    addon_promotion_one_plan_message: '{br}● <bold>{discount}%</bold> en el <bold>Pack de {quantity}</bold>.',
    addon_promotion_title: 'Recuerda que tienes un descuento de:',
  ...
  login: {
    ...
    enter_doppler: `INICIA SESIÓN`,
    enter_doppler_sub: `Tus Campañas te están esperando. Ingresa y sigue haciendo crecer tu negocio.`,
    ...
    you_want_create_account: `¿Aún no tienes cuenta?`,
  },
  master_subscriber: {
    ...
    addons: {
      ...
      cards: {
        card_1: {
          ...
          description: `Revisaremos cada aspecto de tu Estrategia y diseñaremos el plan de acción ideal para alcanzar {br}tu propósito.`,
          subtitle: 'Te ayudaremos a alcanzar los objetivos en tus Campañas ',
          title: 'ASESORIA Y ACOMPAÑAMIENTO ESTRATÉGICO',
        },
        card_2: {
          button: 'Conoce los Add-ons',
          description: 'Añade complementos que mejoran tus Funcionalidades y permiten brindar una experiencia más agradable a tus usuarios.',
      ...
      conversations: {
        ...
        more_information_link: 'https://www.fromdoppler.com/es/conversaciones/?utm_source=direct',
      ...
      custom_reports: {
        ...
        more_information_link: 'https://www.fromdoppler.com/es/metricas-email-marketing/?utm_source=direct',
      ...
      eco_ai: {
        ...
        description: 'Potencia tu estrategia con tu propio asistente de Marketing. Eco analiza tu cuenta, detecta oportunidades y te propone acciones concretas para mejorar tus resultados en Doppler.',
        month_legend: '*Por mes',
      ...
      landing_pages: {
        ...
        month_legend: '*Por mes',
        more_information_link: 'https://www.fromdoppler.com/es/landing-pages/?utm_source=direct',
        packs_from_legend: 'Packs desde',
        title: 'Pack de Landing Pages',
      },
      layout_service: {
        description: 'Si las Plantillas Prediseñadas no coincide con tus necesidades, te ayudamos a crear Plantillas especificas para tu negocio.',
      ...
      list_conditioning: {
        description: 'Depura tus Bases de Datos para que envíes Campañas con Listas de Contactos reales y actuales que generen beneficios a tu negocio.',
        from_contact_legend: 'A partir de',
        price_legend: '*Por Contacto',
      ...
      onsite: {
        ...
        month_legend: '*Por mes',
        more_information_link: 'https://www.fromdoppler.com/es/on-site/?utm_source=direct',
        plans_from_legend: 'Planes desde',
        title: 'OnSite Marketing',
      },
      push_notification: {
        description: 'Envía mensajes promocionales o informativos e impacta a tus visitantes incluso cuando no estén en tu Sitio.',
        month_legend: '*Por mes',
        more_information_link: 'https://www.fromdoppler.com/es/notificaciones-push/?utm_source=direct',
        plans_from_legend: 'Planes desde',
      ...
      sms: {
        ...
        more_information_link: 'https://www.fromdoppler.com/es/campanas-sms/?utm_source=direct',
      ...
      transactional_emails: {
        buy_url: 'https://www.dopplerrelay.com/precios',
        ...
        month_legend: '*Por mes',
        more_information_link: 'https://help.fromdoppler.com/es/doppler-relay-conoce-servicio-email-transaccional/?utm_source=direct',
    ...
    addtional_services: {
      ...
      forms: {
        features: {
          ...
          dedicated_environment: 'Entorno dedicado',
          dedicated_ip: 'IP dedicada',
          features_label: '*Selecciona el/los servicios adicionales de tu interés:',
          landing_page_package: 'Pack de Landing Pages',
          layout_service: 'Servicio de Maquetación',
          list_conditioning: 'Acondicionamiento de Listas',
          sms_sending_and_automation: 'Envío y automatización de SMS',
          strategic_support: 'Acompañamiento estratégico',
          transactional_emails: 'Envíos Transaccionales',
        },
        label_contact_schedule: `*¿En qué horario podemos llamarte?`,
        label_email: `*Email`,
        label_firstname: `*Nombre`,
        label_lastname: `*Apellido`,
        label_phone: `*Teléfono`,
        label_volume: '*Volumen de envíos por mes:',
        placeholder_phone: `9 11 2345-6789`,
        ...
        send_button: 'Enviar',
        success_message: '¡Excelente! Nos pondremos en contacto a la brevedad',
        volume_0: 'Menos de 500K',
        volume_10m: 'Más de 10M',
        volume_1m: 'Entre 1M y 10M',
        volume_500: 'Entre 500K y 1M',
      ...
      legal: {
        additional_information: `<Strong>Información adicional:</Strong> En la <Link>Política de Privacidad</Link> de Doppler encontrarás información
adicional sobre la recopilación y el uso de su información personal por parte de Doppler,
incluida información sobre acceso, conservación, rectificación, eliminación, seguridad, transferencias transfronterizas y otros temas.`,
        legitimation_legend: `<Strong>Legitimación:</Strong> Consentimiento del interesado.`,
        purpose_legend: `<Strong>Finalidad:</Strong> Proveerte información de los productos o servicios sobre los que has consultado en este formulario.`,
        recipients_legend: '<Strong>Destinatarios:</Strong> Tus datos serán guardados por Doppler y Digital Ocean como empresa de hosting.',
        title: 'Doppler te informa que los datos de carácter personal que nos proporciones al rellenar el presente formulario serán tratados por Doppler LLC como responsable de esta web.',
      },
      title: 'Servicios Adicionales',
    },
    cancellation: {
...
¿Estas seguro que deseas cancelar?`,
      ...
      form: {
        ...
        cancellation_reason_options: {
          ...
          others: 'Otros',
          registered_by_mistake: 'Me registré por error o no era el servicio que buscaba',
        },
    ...
    subscription_details: {
      ...
      addon: {
        ...
        conversation_plan: {
          ...
          plan_message: '{total} Mensajes',
          rooms_title: '{rooms, plural, one {# Sala}other {# Salas} }',
        ...
        push_notification_plan: {
          ...
          addon_promotion_all_plans_message: `{br}● <bold>{discount}%</bold> para todos los <bold>Planes</bold>.
          {expirationDate, select, null {} other { Válido hasta el <bold>{expirationDate}</bold>.}}`,
          addon_promotion_one_plan_message: `{br}● <bold>{discount}%</bold> para el <bold>Plan de {quantity} envíos</bold>.
          {expirationDate, select, null {} other { Válido hasta el <bold>{expirationDate}</bold>.}}`,
          addon_promotion_title: 'Recuerda que tienes un descuento de:',
...
continúa usando todas las herramientas de Doppler para que tu negocio crezca.`,
      ...
      plan_type_prepaid_message: '{quantity} Créditos disponibles',
      plan_type_subscribers_label: 'Plan por Contactos',
      plan_type_subscribers_message: '{quantity} Contactos',
      sms: {
        available_sms_amount: 'US$ {amount} Disponible para SMS',
        load_button: 'Cargar',
        title: 'Envío y automatización de SMS',
      },
      start_test_button: 'Comenzar Prueba',
      subtitle: 'Aquí tienes el detalle de lo que incluye tu Plan contratado. Verás las Funcionalidades  que comprende y la información relacionada con tus pagos.',
      title: `Plan de Email Marketing`,
      try_now_button: 'Probar Ahora',
...
El código es inválido.`,
  ...
  push_notification_section: {
    panel: {
      available_sends: 'Disponibles: ',
      button_configure_domain_label: 'Configurar',
      button_configure_domain_link: `${urlSiteTracking}`,
      change_plan: 'CAMBIAR PLAN',
      consume_state_title: 'Estado de Consumos',
      consumed_sends: 'Consumidos:  **{quantity} Envíos**',
      countdown_message_plural: 'Te quedan **{days} días** para finalizar tu periodo de prueba de Notificaciones Push de Doppler.',
      countdown_message_singular: 'Te queda **{days} día** para finalizar tu periodo de prueba de Notificaciones Push de Doppler.',
      date_expiration_error: ' ¡Tu prueba terminó! Activa un plan y sigue llegando a tus clientes con Notificaciones Push efectivas.',
      description: 'Ahora puedes ver cuántos envíos te quedan disponibles y gestionarlas fácilmente desde aquí.',
      description1: 'Comienza a utilizar este Add-on y transforma a tus visitantes en clientes, con mensajes efectivos y segmentados.\n\nRealiza los siguientes pasos:',
      description2: '1. Ingresa en el botón **Configuración**.\n2. Desde la sección Seguimiento en sitio y Notificaciones Push **verifica el dominio de tu Sitio Web**.\n3. Habilita **Notificaciones Push**.',
      exceeded: 'Llegaste al máximo de envíos de tu Plan. Las Notificaciones siguen activas con **Envíos Excedentes**. Si no deseas usarlos,',
      exceeded2: 'simplemente pausa tus envíos.',
      exceeded_sends: 'Consumo excedente:',
      purchase_plan: 'ADQUIRIR PLAN',
      sends: '{quantity} Envíos',
      sends_month: '{quantity} Envíos/ mes',
      sends_option: 'Opciones de Envío',
      sends_option_pause: 'Control de Notificaciones Push',
      sends_option_pause_description: 'Si desactivas este **Add-on**, tus Notificaciones Push se pausarán temporalmente. Al reactivarlo, los envíos **se retomarán de forma automática**.',
...
Plantillas de Email y crear Automations de Carrito Abandonado y Producto Visitado. ¿Tienes dudas? Presiona [HELP](${urlHelp}/como-integrar-doppler-y-shopify/).`,
  ...
  signup: {
    ...
    create_account_title: `CREA TU CUENTA GRATIS`,
    ...
    have_doubts: `¿Necesitas ayuda? <a>Contáctanos</a> y te acompañaremos en el proceso.`,
    head_description: `Atrae, convierte y fideliza clientes con el poder del Email Marketing Automation. ¡Ingresa a Doppler!`,
    head_title: `Email Marketing Automation gratis y con envíos ilimitados | Doppler`,
...
eliminación, seguridad, transferencias transfronterizas y otros temas.
  `,
    ...
    resend_email: `Solicita un nuevo envío aquí.`,
    sign_up_sub: `Potencia tu Marketing Multicanal con Doppler.{br}Envía Emails ilimitados a 500 Contactos durante 90 días. Incluye acceso completo a Doppler Academy.{br}
¿Ya tienes una cuenta? <Link>Inicia sesión</Link>`,
