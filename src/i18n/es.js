...
const messages_es = {
  ...
  checkoutProcessSuccess: {
    ...
    discount_quarterly: '3 meses',
    discount_yearly: '12 meses',
    flashcard_mercadopago_message: 'Te avisaremos por Correo Electrónico cuando el pago se haya acreditado. Recuerda que puede demorar hasta 48 horas.',
    flashcard_transfer_message: 'Podrás empezar a usar tu nuevo Plan una vez que envíes el comprobante de pago por Correo Electrónico.',
    flashcard_transfer_note_1: 'Dentro de las próximas <bold>24 horas hábiles</bold> recibirás la factura por Correo Electrónico.',
    flashcard_transfer_note_2: 'También podrás verla y descargarla desde la sección <bold>Información de Facturación</bold> de tu Panel de Control.',
    flashcard_transfer_note_3: `Recuerda enviar el comprobante de pago a <bold>billing@fromdoppler.com</bold> para que podamos activar tu nuevo Plan.`,
    flashcard_transfer_note_3_ar: `Recuerda enviar el comprobante de pago a <bold>administracion@fromdoppler.com</bold> para que podamos activar tu nuevo Plan.`,
    plan_type_monthly: 'Envíos:',
    plan_type_monthly_availables: 'Envíos Disponibles:',
    ...
    plan_type_prepaid_total: 'Total Créditos disponibles:',
    plan_type_subscribers: 'Contactos:',
    plan_type_subscribers_availables: 'Contactos Disponibles:',
    purchase_finished_title: 'Compra Finalizada',
    renewal_type_title: 'Tipo de renovación:',
