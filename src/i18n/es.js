...
const messages_es = {
  ...
  big_query: {
    ...
    free_text_data_studio_MD: `Aprende a configurar nuestro tablero de [Data Studio en unos pocos pasos](https://datastudio.google.com/overview), o accede a BigQuery mediante otra herramienta de visualización de datos como Tableau.`,
