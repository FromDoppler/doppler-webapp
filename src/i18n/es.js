...
const messages_es = {
  ...
  buy_process: {
    ...
    feature_item_chat_plan: `Incluye hasta {units} conversaciones`,
    'feature_item_monthly-deliveries': `Incluye hasta {units} envíos`,
    feature_item_prepaid: `Incluye hasta {units} créditos`,
    feature_item_subscribers: `Incluye hasta {units} contactos`,
...
El código es inválido.`,
  ...
  plan_types: {
    ...
    min_monthly_plan_price: `<Span>Desde</Span> <H3>US$ {price}/mes</H3>`,
