...
const messages_es = {
  ...
  big_query: {
    ...
    plus_body_step_one_HD: `Agregar permiso para cuentas de google. [Ver Help](https://cloud.google.com/bigquery/docs/?hl=es-419)`,
    plus_body_step_two_HD: `Completa la configuración en Data Studio. [Ver Help](https://datastudio.google.com/overview)`,
    plus_btn_cancel: `Cancelar`,
    plus_btn_save: `Guardar`,
    plus_configuration: `Configuración`,
    plus_control_panel: `Panel de control`,
    plus_error_message_empty: `El campo esta vacio`,
    plus_error_message_not_email: `El texto del campo no es un correo electronico`,
    plus_header_MD: `Integra [Google Big Query](https://cloud.google.com/bigquery?hl=es)
    para analizar reportes detallados sobre tus campañas,tus suscriptores y otros datos de tu cuenta en un tablero personalizable.`,
    plus_input_place_holder: `Agregar cuenta de google`,
    plus_message_remember: `Recuerda Guardar los Cambios`,
    plus_message_saved: `Cambios guardados con exito`,
    plus_paragraph_two: `Google Big Query`,
    plus_step_one: `1er Paso`,
    plus_step_one_paragraph: `Todas las direcciones de emails en esta lista tendran acceso a la base de datos de tu cuenta en Google Big query, 
    Enviaremos un email notificando a las cuentas que agregues.`,
    plus_step_two: `2do Paso`,
    plus_step_two_paragraph: `Aprende a configurar nuestro tablero de Data Studio en unos pocos pasos`,
