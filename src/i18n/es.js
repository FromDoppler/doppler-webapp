...
const messages_es = {
  ...
  buy_process: {
    ...
    plan_selection: {
      ...
      plan_type_monthly_deliveries_label: '¿Cuántos envíos deseas en tu plan?',
      plan_type_prepaid_info: 'Envía Emails a partir de créditos acumulables y sin vencimiento. ',
      plan_type_prepaid_label: '¿Cuántos Créditos deseas agregar a tu plan?',
      plan_type_subscribers_info: 'Envía Emails ilimitados en base a tu cantidad de Contactos.',
      plan_type_subscribers_label: '¿Cuántos contactos deseas en tu plan?',
    },
    promocode: {
      apply_btn: `Aplicar`,
