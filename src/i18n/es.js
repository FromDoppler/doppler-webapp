...
El código es inválido.`,
  ...
  push_notification_section: {
    panel: {
      ...
      countdown_message_plural: "Te quedan **{days} días** para finalizar tu periodo de prueba de Notificaciones Push.",
      countdown_message_singular: "Te queda **{days} día** para finalizar tu periodo de prueba de Notificaciones Push.",
      date_expiration_error: "**Tu periodo de prueba ha finalizado**. Para continuar utilizando **Notificaciones Push** adquiere un plan.",
      description: 'Comienza a utilizar este Add-on y transforma a tus visitantes en clientes, con mensajes efectivos y segmentados.\n\nRealiza los siguientes pasos:',
      ...
      exceeded: "Consumiste todas los envíos disponibles en tu Plan, tus Notificaciones se continuan enviando con el consumo de",
      exceeded2: "**Envíos Excedentes**. Si no deseas usar envíos excedentes puedes pausar tus campañas de Automation Push.",
      ...
      sends_option_pause: 'Pausar envíos de Notificaciones Push',
...
los usuarios, detecta puntos de fuga y oportunidades de mejora! Si necesitas ayuda, presiona [HELP](${urlHelpAdvancedReports}).
  ...
  rfm: {
    ...
    subtitle: `Al utilizar RFM vas a poder segmentar tus contactos de manera estratégica según su Recencia, Frecuencia y Valor Monetario. Esto te permitirá identificar los clientes más valiosos, comprender mejor sus comportamientos y diseñar campañas más efectivas y personalizadas, optimizando así el impacto de tus acciones de marketing.`,
