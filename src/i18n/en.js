...
other {}}}}}}}}}}
  ...
  buy_process: {
    ...
    new_plan_selection: {
      ...
      emails_downgrade_warning_message: '<bold>Need to reduce deliveries?</bold>{br}If you need to reduce your Plan deliveries, contact our team so we can help you with the change.',
      emails_extra_email_price: 'Extra email cost US$ {price}',
      emails_label: 'How many Deliveries do you need?',
      emails_more_than_10m_info_message: '<bold>Need more Deliveries?</bold>{br}Contact our team so we can offer you a custom Plan that fits your business needs.',
      ...
      included_features: {
        ...
        item_2_description: 'Use AI to create better subjects, content, and campaign pieces in less time.',
        item_2_title: 'Optimize your time with AI',
        item_3_description: 'Segment your audiences and personalize each message based on interests, behavior, and stage.',
        item_3_title: 'Talk to each customer as if they were unique',
        item_4_description: 'Coordinate campaigns across channels to keep consistent conversations with your audience.',
        item_4_title: 'Reach your customers where they are',
        item_5_description: 'Access detailed reports to measure performance, detect opportunities, and make better decisions.',
        ...
        modal_sections: {
          automation_marketing: {
            ...
            description_2: 'Activate ready-to-use automations and start communicating without configuring from scratch.',
            description_3: 'Combine Email, SMS, and Push Notifications from a single platform, automatically.',
            description_4: 'Recover lost sales with automatic reminders to Contacts who did not complete their purchase.',
            name_1: 'Automated Flows',
            name_2: 'Prebuilt Flows',
          ...
          email_marketing_ai: {
            ...
            description_2: 'Create AI-optimized subject lines to increase your open rate.',
            description_3: 'AI suggests the exact time to send each Email, maximizing your open rate.',
            description_4: 'Test two versions of your Campaign and automatically send the best one.',
            description_5: 'Create impactful Emails from attractive designs.',
            name_1: 'Content Generation',
            name_2: 'Effective Subjects',
            name_3: 'Smart Sending',
            name_4: 'A/B Test',
            name_5: 'Professional templates',
            title: 'Email Marketing powered by AI',
          },
          reports_analytics: {
            description_1: 'Identify which Campaigns perform best and detect optimization opportunities in real time.',
            description_2: 'Make data-backed decisions: Open Rate, Click Rate, and more.',
            description_3: 'Monitor bounces, unsubscribes, and inactivity to keep your Lists healthy and improve delivery.',
            description_4: 'Understand Contact behavior and make decisions based on real data.',
          ...
          segmentation_advanced: {
            description_1: 'Assign an automatic score to each Contact based on their interaction with personalized content.',
            description_2: 'Adapt each communication based on the information and interests of every Contact.',
            description_3: 'Use specific data from your Contacts to build custom segments.',
