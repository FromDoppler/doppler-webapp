...
const messages_en = {
  ...
  big_query: {
    ...
    plus_body_step_one_HD: `Add permission for google accounts. [See Help] (https://cloud.google.com/bigquery/docs/?hl=es-419)`,
    plus_body_step_two_HD: `Complete the setup in Data Studio. [See Help](https://datastudio.google.com/overview)`,
    plus_btn_cancel: `Cancel`,
    plus_btn_save: `Save`,
    plus_configuration: `Configuration`,
    plus_control_panel: `Control Panel`,
    plus_error_message_empty: `The field is empty.`,
    plus_error_message_not_email: `The field text is not an email.`,
    plus_header_MD: `Integrate [Google Big Query](https://cloud.google.com/bigquery?hl=es)
    to analyze detailed reports on your campaigns, your subscribers and other data of your account in a customizable dashboard.`,
    plus_input_place_holder: `Add google account.`,
    ...
    plus_step_one: `1st Step`,
    plus_step_one_paragraph: `All the email addresses in this list will have access to the database of your account in Google Big query,
    We will send an email notifying the accounts you add.`,
    plus_step_two: `2nd Step`,
    plus_step_two_paragraph: `Learn how to configure our Data Studio dashboard in a few steps`,
