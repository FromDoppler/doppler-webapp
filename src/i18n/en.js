...
deletion, security, cross-border data transfers and other issues.
  `,
    ...
    resend_email: `<underline>Resend activation email.</underline>`,
...
With Doppler you can generate Segments with common interests, create Forms to attract new Contacts and more.`,
  ...
  updatePaymentInformationSuccess: {
    ...
    not_all_invoices_processed_legend: 'In any case, your account has been reactivated <bold>momentarily</bold> so that you can use the service. We will contact you to manage the payment of the remaining balance.',
    ...
    payment_pending_title: 'The reprocess has been partially successful.',
    rejected_payments_legend_1: `Try another card`,
    rejected_payments_legend_2: `or [contact us](${mailtoSupport}) so we can help you.`,
