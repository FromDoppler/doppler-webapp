...
const messages_en = {
  ...
  checkoutProcessForm: {
    ...
    purchase_summary: {
      ...
      explanatory_legend: 'The renewal is automatic and you can cancel it whenever you want. The price of the Plan does not include taxes.',
      ...
      promocode_legend: 'Enter a promo code',
