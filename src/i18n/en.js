...
const messages_en = {
  ...
  buy_process: {
    billing_type_1: `Billing monthly`,
    billing_type_12: `Billing yearly`,
    billing_type_3: `Billing quarterly`,
    billing_type_6: `Billing half-yearly`,
    buy_now_title: `Buy now`,
    chat_plan_title: `Chat plan`,
    discount_half_yearly: 'Biyearly',
    discount_monthly: 'Monthly',
    discount_percentage: `Save {discountPercentage}%`,
    discount_quarterly: 'Quarterly',
    discount_yearly: 'Yearly',
    feature_item_chat_plan: `Includes up to {units} conversations`,
    'feature_item_monthly-deliveries': `Includes up to {units} emails`,
    feature_item_prepaid: `Includes up to {units} credits`,
    feature_item_subscribers: `Includes up to {units} contacts`,
    marketing_plan_title: `Marketing plan`,
    min_monthly_plan_price: `<P>From <Strong>US$ {price}*/month</Strong></P>`,
    min_single_plan_price: `<P>From <Strong>US$ {price}*/single</Strong></P>`,
...
Promo code isn’t valid.`,
  ...
  plan_types: {
    ...
    min_monthly_plan_price: `<Span>Since</Span> <H3>US$ {price}/month</H3>`,
