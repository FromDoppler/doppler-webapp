...
const messages_en = {
  ...
  chat_selection: {
    expiration_free_plan_message: 'EN - Recuerda que al contratar un plan de conversaciones, finalizara de manera automática la versión de prueba de tres meses',
    how_many_conversations_need_message: 'EN - ¿Cuántas conversaciones necesitas por mes?',
    plan_benefits: {
      additional_costs: {
        additional_agent_message: 'EN - Agente adicional.',
        additional_channel_message: 'EN - Canal adicional.',
        additional_conversation_message: 'EN - Conversación adicional.',
        additional_costs_message: 'EN - Costos Adicionales',
        extra_costs_message: 'EN - Costos extras',
        legend_1_message: 'EN - Podrá contratar adicionales desde Mi Plan una vez superados los valores establecidos por su plan.',
        legend_2_message: 'EN - Etiam rhoncus leo ut ante faucibus laoreet. Cras eros nibh, semper sodales ex id, ullamcorper mattis.',
      },
      collaborative_care_message: 'EN - Atención colaborativa',
      custom_integrations_message: 'EN - Integraciones personalizadas',
      default_messages_message: 'EN - Mensajes predeterminados',
      facebook_messenger_chat_message: 'EN - Chat en Facebook Messenger',
      included_all_plans_message: 'EN - Incluido en todos los planes',
      included_paid_plans_message: 'EN - Incluido en todos los planes pagos',
      instagram_chat_message: 'EN - Chat en Instagram',
      lead_generator_message: 'EN - Generador de Leads',
      messages_by_conversation_tree_message: 'EN - Mensajes por árbol de conversaciones',
      messages_tracking_message: 'EN - Seguimiento de mensajes',
      support_message: 'EN - Soporte',
      tags_message: 'EN - Etiquetas',
      title: 'EN - Beneficios plan',
      website_chat_message: 'EN - Chat en Sitio Web',
      whatsapp_business_api_chat_message: 'EN - Chat en WhatsApp Business API',
      whatsapp_business_api_send_messages_message: 'EN - Envio de mensajes en WhatsApp Business API',
    },
    plan_chat_info: {
      legend: 'EN - Contactanos para que Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis montes eget proin purus. Faucibus viverra suspendisse molestie viverra.',
      section_1: {
        legend: 'EN - Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis montes eget proin purus. Faucibus viverra suspendisse molestie viverra hac.',
        title: 'EN - Subtitulo',
      },
      section_2: {
        legend: 'EN - Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis montes eget proin purus. Faucibus viverra suspendisse molestie viverra hac.',
    ...
    selected_plan_chat: {
      add_to_cart_button: 'EN - Agregar al carrito',
      agent_with_plural: `{agents, plural, one {# EN - Agente}other {# EN - Agentes} }`,
      channel_with_plural: `{channels, plural, one {# EN - Canal}other {# EN - Canales} }`,
      conversations_plan_message: 'EN - Plan Conversaciones',
      includes_until_conversations_message: 'EN - Incluye hasta {conversations} conversaciones',
      month_message: 'EN - mes',
      no_chat_plan_selected_message: 'EN - No se ha seleccionado un plan de chat',
      remove_from_cart_button: 'EN - Remover del carrito',
    },
    title: 'EN - Quieres agregar un plan de chat?',
  },
  checkoutProcessForm: {
