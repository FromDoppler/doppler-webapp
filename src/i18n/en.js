...
const messages_en = {
  ...
  checkoutProcessSuccess: {
    ...
    discount_quarterly: '3 months',
    discount_yearly: '12 months',
    flashcard_mercadopago_message: 'We’ll notify you by Email when the payment has gone through. It can take up to 48 hours.',
    flashcard_transfer_message: 'You’ll be able to use your new Plan once you send the payment voucher by Email.',
    flashcard_transfer_note_1: 'Through the next <bold>24 working hours</bold> you’ll receive the invoice by Email.',
    flashcard_transfer_note_2: 'You can also see and download it from the <bold>Billing Information</bold> section of your Control Panel.',
    flashcard_transfer_note_3: `Remember to send the payment proof to <bold>billing@fromdoppler.com</bold> so we can activate your new Plan.`,
    flashcard_transfer_note_3_ar: `Remember to send the payment proof to <bold>administracion@fromdoppler.com</bold> so we can activate your new Plan.`,
    plan_type_monthly: 'Emails:',
    plan_type_monthly_availables: 'Available Emails:',
    ...
    plan_type_prepaid_total: 'Total available Credits:',
    plan_type_subscribers: 'Contacts:',
    plan_type_subscribers_availables: 'Available Contacts:',
    purchase_finished_title: 'Purchase Finished',
    renewal_type_title: 'Renovation type:',
