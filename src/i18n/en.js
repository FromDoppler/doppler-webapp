...
You'll find an Email with steps to follow.`,
  ...
  login: {
    ...
    enter_doppler_sub: `Boost Your Multichannel Marketing Strategy with Doppler
Create your account to receive 90 days of free access to the platform and permanent access to Doppler Academy.`,
...
deletion, security, cross-border data transfers and other issues.
  `,
    ...
    sign_up_sub: `Boost your Multichannel Marketing Strategy with Doppler!{br}Sign up to receive 90 days' free access to the platform,
      plus permanent access to the Doppler Academy.{br}Don't have an account yet? Sign up for free.`,
