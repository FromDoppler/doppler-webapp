...
You'll find an Email with steps to follow.`,
  ...
  onsite_promotional: {
    ...
    features: {
      capture_information: "**Web Chatbot:** Manage your user's attention in real time and convert your visitors into customers.",
      display_products_of_interest: '**WhatsApp Marketing:** Automate and personalize instant messages and attract a larger audience.',
      offer_complementary_products: "**WhatsApp Chatbot:** Manage your user's attention in real time and convert your visitors into potential customers.",
      product_history: '**Decision Tree:** Design the conversational journey that users will have every time they communicate with your brand.',
      promote_your_products: '**Social Media Chatbot:** Manage queries coming from Facebook and Instagram on a single dashboard, providing personalized attention.',
    },
    paragraph_free_MD: '**Implement Conversations in your Marketing Strategy!** You can try it during your free trial or until you use 200 Conversations.',
    paragraph_free_expired_MD: '**Implement conversations in your Marketing Strategy!** Get a plan according to your needs.',
    paragraph_not_free_MD: '**Implement Conversations in your Marketing Strategy!** You can try it free for 90 days or until you use 200 Conversations.',
