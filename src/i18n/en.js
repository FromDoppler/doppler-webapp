...
You'll find an Email with steps to follow.`,
  ...
  invoices_list: {
    ...
    no_download_msg: `There is no invoice to download`,
  ...
  plan_calculator: {
    ...
    exlusive_plan_promotion: `Do you have more than 100.000 contacts? __[Contact us to hire an exclusive plan](${''})__.`,
