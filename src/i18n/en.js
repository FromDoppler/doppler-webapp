...
Want to know more? Press [HELP](${urlHelp}/contact-policy).`,
  ...
  dashboard: {
    ...
    first_steps: {
      completed_message: `
<Paragraph>Excellent! You have successfully completed the first steps in Doppler. Now you will find some useful shortcuts to the most frequently used functions. <Button><Bold>Activate quick actions</Bold></Button>.</Paragraph>
      `,
