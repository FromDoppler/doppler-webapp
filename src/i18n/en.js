...
const messages_en = {
  ...
  chat_selection: {
    ...
    plan_benefits: {
      ...
      facebook_messenger_chat_message: 'Chatbot on Facebook Messenger',
      ...
      instagram_chat_message: 'Chatbot on Instagram',
      ...
      website_chat_message: 'Chatbot Web',
      whatsapp_business_api_chat_message: 'Chatbot on WhatsApp',
  ...
  my_plan: {
    addons: {
      ...
      custom_reports: {
        ...
        monthly_report_legend: 'Reporte mensual - EN',
      ...
      dedicated_ip: {
        access_by_legend: 'Accede por - EN',
        description: 'Obtén una IP dedicada, exclusivamente para tus envíos. Seteada bajo minuciosos estándares de seguridad, para una óptima entregabilidad. - EN',
        month_legend: '*Por mes - EN',
        title: 'IP Dedicada - EN',
      },
      landing_pages: {
        description: 'Utiliza páginas de destino para captar a tus clientes en múltiples dispositivos y guíalos a la conversión. - EN',
        month_legend: '*Por mes - EN',
        packs_from_legend: 'Packs desde - EN',
        title: 'Pack de Landing Pages - EN',
      },
      layout_service: {
        ...
        editor_piece_legend: '*Por pieza en editor - EN',
        html_piece_from_legend: 'Desde - EN',
        html_piece_legend: '*Por pieza en Html - EN',
        title: 'Servicio de Maquetación - EN',
      },
      list_conditioning: {
        description: 'Depuramos tus bases de datos para que puedas enviar campañas con listas de contactos reales y actuales, generen beneficios a tu negocio. - EN',
        from_contact_legend: 'A partir de {contacts} contactos - EN',
        price_legend: '*Precio por contacto - EN',
        title: 'Acondicionamiento de Listas - EN',
      },
      more_information_link: 'Más información - EN',
      onsite: {
        description: 'Agrega ventanas emergentes como Pop-ups, Formularios y otras herramientas interactivas. Fomenta la interacción en tu Sitio Web y mejora la Conversión en tu E-commerce. - EN',
        month_legend: '*Por mes - EN',
        plans_from_legend: 'Planes desde - EN',
        title: 'Onsite Marketing - EN',
      },
      push_notification: {
        description: 'Mantén la comunicación con tus clientes enviando mensajes cortos con contenido promocional o informativo.- EN',
        month_legend: '*Por mes - EN',
        plans_from_legend: 'Planes desde - EN',
        title: 'Notificaciones Push - EN',
      },
...
incluida información sobre acceso, conservación, rectificación, eliminación, seguridad, transferencias transfronterizas y otros temas.`,
    ...
    subscription_details: {
      addon: {
        conversation_plan: {
          available_message: '{available}/{total} conversaciones disponibles - EN',
          free_label: 'Prueba Gratuita - EN',
          plan_message: '{total} conversaciones - EN',
          title: 'Plan de conversaciones - EN',
        },
        landings_plan: {
          landings_packs_message: '{landingQty} Pack de {landingPack} Landing pages - EN',
          plan_message: '{total} conversaciones - EN',
          subtitle: 'Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis - EN',
          title: 'Pack de Landing pages - EN',
        },
        onsite_plan: {
          available_message: '{available}/{total} impresiones disponibles - EN',
          free_label: 'Prueba Gratuita - EN',
          plan_message: '{total} impresiones - EN',
          title: 'Plan de onsite - EN',
        },
        push_notification_plan: {
          available_message: '{available}/{total} envíos disponibles - EN',
          free_label: 'Prueba Gratuita - EN',
          plan_message: '{total} envíos - EN',
          title: 'Plan de notificaciones push - EN',
        },
      },
      available_contacts: 'contactos disponibles - EN',
      billing: {
        single_payment: 'Pago Único - EN',
        title: 'Facturación - EN',
        type_1: `Mensual - EN`,
        type_12: `Anual - EN`,
        type_3: `Trimestral - EN`,
        type_6: `Semestral - EN`,
      },
      cancel_subscription_button: 'Cancelar suscripción - EN',
      cards: {
        card_1: {
          button: 'Solicitar consultoría - EN',
          description: 'Revisaremos juntos cada aspecto de tu estrategia actual y te ayudaremos a diseñar el plan de acción ideal para alcanzar tus objetivos. - EN',
          subtitle: 'Te ayudaremos a alcanzar los objetivos en tus campañas - EN',
          title: 'ASESORIA Y ACOMPAÑAMIENTO ESTRATEICO - EN',
        },
        card_2: {
          button: 'Conocer más - EN',
          description: 'Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis montes eget proin purus. Faucibus viverra suspendisse molestie viverra. - EN',
          subtitle: 'Descubre Add-ons para potenciar tu negocio - EN',
          title: 'SERVICIOS ADICIONALES ESPECIFICOS - EN',
        },
      },
      change_plan_button: 'Cambiar de plan - EN',
      features: {
        feature_1: 'Campañas de Email clásicas, sociales y Test A/B. - EN',
        feature_2: 'Formularios de Suscripción Clásicos y Pop-up. - EN',
        feature_3: 'Flujos Automatizados. - EN',
        feature_4: 'Notificaciones Push. - EN',
        feature_5: 'Campañas de SMS. - EN',
        see_all_features: 'Ver todas las funcionalidades - EN',
        title: 'Funcionalidades - EN',
      },
      plan_type_free_label: 'Prueba Gratuita - EN',
      plan_type_monthly_deliveries_label: 'Plan por Envíos - EN',
      plan_type_prepaid_label: 'Plan por Créditos - EN',
      plan_type_subscribers_label: 'Plan por Contactos - EN',
      sms: {
        available_sms_amount: 'US$ {amount} Disponible para SMS - EN',
        load_button: 'Cargar - EN',
        title: 'Envío y automatización de SMS - EN',
      },
      title: `Plan de email marketing - EN`,
      unlimited_emails: 'Envíos ilimitados - EN',
      view_other_packs: 'Ver otros packs - EN',
    },
    tabs: {
      addons: 'Add-ons - EN',
      billing_history: 'Historial de Facturación - EN',
      payment_method: 'Método de Pago - EN',
      subscription_details: 'Detalle de suscripción - EN',
    },
    title: 'Mi plan - En',
  },
  onsite_promotional: {
