...
other {}}}}}}}}}}
      ...
      slice_5_title: `Don't leave without activating the Add-Ons included in your Promotional Pack!`,
    },
  },
  agencies: {
  ...
  buy_process: {
    ...
    feature_item_ecoia_plan: `Includes up to <Strong>{units}</Strong>`,
    ...
    min_monthly_plan_price_contacts_hardcoded: `<P>From <Strong>US$ 5*/month</Strong> <Strike>US$ 10</Strike></P><Discount>50% OFF Up to 1,500 Contacts.</Discount>`,
    ...
    new_plan_selection: {
      addons_section: {
        ...
        subtitle: 'After getting your Plan, choose the Add-ons that work best for your business.',
        title: 'Boost your Plan with our Add-ons',
      },
      buy_credits: 'Buy Now',
      choose_plan: 'Start your Plan now',
      contact_advisor_cta: 'Contact our team',
      contacts_current_plan_warning_message: 'You cannot select this Plan because it is your current one.',
      contacts_downgrade_warning_message: `<bold>Need to reduce contacts?</bold>{br}Reach out and we'll take care of it.`,
      contacts_label: 'How many Contacts do you have?',
      contacts_option: '{contacts}',
      contacts_option_more_than_100k: 'More than 100,000',
      contacts_plan_description: `Select the Plan that best fits your Email Marketing strategy. Not sure which Plan is right for you? Contact us and we'll help you find it.`,
      ...
      credits_plan_description: `A flexible alternative if you don't want to commit to a monthly subscription and send less frequently.
      Credits don't expire, they accumulate and get cheaper the more you buy.`,
      ...
      custom_price_value: 'Custom*',
      emails_downgrade_warning_message: `<bold>Need to reduce deliveries?</bold>{br} Reach out and we'll help you make the change.`,
      emails_extra_email_price: 'Extra email cost US$ {price}',
      emails_label: 'How many Sends do you need?',
      emails_more_than_10m_info_message: `<bold>Need more Sends?</bold>{br}Reach out and we'll design a Plan around your needs.`,
      emails_option: '{emails}',
      emails_option_less_than_100k: 'Less than 100,000',
      emails_option_more_than_10m: 'More than 10,000,000',
      emails_plan_description: 'Send more, spend less. Unlimited Contacts at the lowest cost per Send. Perfect for businesses with large Contact bases.',
      emails_plan_title: 'Sends Plan',
      ...
      included_features: {
        item_1_description: 'Create and send professional Campaigns to your entire Contact base, no HTML or design skills needed.',
        item_1_title: 'Email Marketing',
        item_2_description: 'Send the right message, to the right Contact, at the exact right time, completely automatically.',
        item_2_title: 'Automation Marketing',
        item_3_description: 'Activate ready-to-use automations and start communicating without setting anything up from scratch.',
        item_3_title: 'Pre-designed Flows',
        item_4_description: 'Generate your Campaign content with Artificial Intelligence in seconds, no creative blocks or wasted time.',
        item_4_title: 'AI-powered Marketing',
        item_5_description: 'Group your Contacts by interests and behavior to reach the right potential customers every time.',
        item_5_title: 'Advanced Segmentation',
        item_6_description: 'Measure the Open Rate, Click Rate and Conversion Rate of every Campaign to optimize your next sends.',
        item_6_title: 'Reports & Analytics',
        modal_sections: {
          automation_marketing: {
            description_1: 'Design sequences with multiple paths and conditions based on each Contact’s behavior.',
            description_2: 'Activate ready-to-use automations and start communicating without setting anything up from scratch.',
            description_3: 'Combine Email, SMS, and Push Notifications from a single platform, automatically.',
            description_4: `Recover lost sales with automatic reminders to Contacts who didn't complete their purchase.`,
            name_1: 'Automated Flows',
            name_2: 'Pre-designed Flows',
            name_3: 'Multichannel Campaigns',
            name_4: 'Abandoned Cart',
            title: 'Automation Marketing',
          },
          email_marketing_ai: {
            description_1: 'Create your Email content in seconds: titles, tone, grammar, and much more.',
            description_2: 'Generate AI-optimized Subject Lines to boost your Open Rate.',
            description_3: 'AI suggests the exact moment to send each Email, maximizing your Open Rate.',
            description_4: 'Test two versions of your Campaign and automatically send the one that performs best.',
            description_5: 'Create impactful Emails from attractive, ready-to-use designs.',
            name_1: 'Content Generation',
            name_2: 'Effective Subject Lines',
            name_3: 'Smart Send',
            name_4: 'Test A/B',
            name_5: 'Professional Templates',
            title: 'AI-powered Email Marketing',
          },
          reports_analytics: {
            description_1: 'Identify which Campaigns perform best and detect optimization opportunities in real time.',
            description_2: 'Make data-driven decisions: Open Rate, Click Rate and more.',
            description_3: 'Monitor bounces, unsubscribes, and inactivity to keep your Lists healthy and improve delivery.',
            description_4: `Understand your Contacts' behavior and make decisions based on real data.`,
            name_1: 'Campaign Performance',
            name_2: 'Key KPI Analysis',
            name_3: 'Database Maintenance',
            name_4: 'Behavior Trends',
            title: 'Reports and Analytics',
          },
          segmentation_advanced: {
            description_1: 'Automatically assign a score to each Contact based on their interaction with personalized content.',
            description_2: `Tailor every communication based on each Contact's data and interests.`,
            description_3: 'Use specific Contact data to build fully customized Segments.',
            name_1: 'Contact Scoring',
            name_2: 'Dynamic Personalization',
            name_3: 'Custom Fields',
            title: 'Advanced Segmentation',
          },
        },
        modal_title: 'Features and Solutions',
        see_more: 'See more features',
        subtitle: 'All Plans include every feature. See everything Doppler can do for you!',
        title: `Get all features from day one, with Doppler's most accessible Plan.`,
      },
      month_period: 'month',
      more_than_100k_contact_link: 'CONTACT US',
      more_than_100k_info_message: '<bold>More than 100K Contacts?</bold>{br}The Sends Plan is for you: unlimited Contacts, lower cost per Send and fully customized to your needs.',
      payment_period_half_yearly: 'semiannual',
      payment_period_monthly: 'monthly',
      payment_period_quarterly: 'quarterly',
      payment_period_yearly: 'annual',
      ...
      sticky_custom_title: 'Customized Email Plan',
    ...
    plan_selection: {
      ...
      lose_promotion_message: 'If you switch your Plan, you will lose the benefits you currently have through your Promo Code.',
      ...
      plan_type_monthly_deliveries_selector: 'How many emails do you want in your plan?',
      plan_type_prepaid_info: 'Send Emails from cumulative Credits without expiration.',
      plan_type_prepaid_label: 'Credits',
      plan_type_prepaid_selector: 'How many Credits do you want to add to your plan?',
    ...
    shopping_cart: {
      ...
      next_invoices_estimate: 'The value of "Next invoices" is estimated and may vary based on the dollar exchange rate at the time of issue.',
  ...
  checkoutProcessForm: {
    ...
    payment_method: {
      ...
      dni: 'DNI',
      eprotect_error: {
        cvv_invalid: 'Ouch! Invalid security code. Please check and try again.',
        expired_paypage_registration_id: 'Ouch! Session expired. Please refresh the page and try again.',
        invalid_validation_number: 'Invalid security code',
        merchant_not_authorized: 'Ouch! We are unable to process payments at this time. Please contact support.',
        payframe_failed_to_load: 'Ouch! Unable to load payment form. Please refresh the page and try again.',
        unable_to_encrypt_field: 'Ouch! Unable to process your card information. Please try again.',
      },
    ...
    purchase_summary: {
      ...
      promocode_can_not_apply_error_all_plan_item_message: `● Marketing Plans by <bold>{planType, select, 4 {Contacts} other {{planType, select, 3 {Credits} other {Emails}}}}</bold>.`,
      promocode_can_not_apply_error_message: `<bold>This discount code applies to the following:</bold>`,
      promocode_can_not_apply_error_plan_item_message: `● Marketing Plan with <bold>{quantity} {planType, select, 4 {Contacts} other {{planType, select, 3 {Credits} other {Emails}}}}</bold>.`,
      promocode_error_message: 'Invalid code',
      promocode_expired_error_message: 'Expired code',
      promocode_header: 'Got a discount code?',
...
Payment details will be included in the invoice sent to the recipient you have indicated.`,
    ...
    transfer_bank_account_label: 'CC',
    transfer_bank_alias_label: 'Alias',
    transfer_bank_cbu_label: 'CBU',
    transfer_bank_copied_message: 'Copied',
    transfer_bank_copy_button: 'Copy {label}',
    transfer_bank_holder_label: 'Holder',
    transfer_bank_name_label: 'Bank',
    transfer_bank_tax_id_label: 'CUIT',
    transfer_bank_transfer_message: 'Complete your payment of <Bold>$ {total}(ARS)</Bold> by making a deposit or bank transfer to the following account:',
    ...
    transfer_confirmation_message: "As soon as we confirm your payment, we'll email you so you can start making the most of your new Plan and everything Doppler has to offer.",
    transfer_explore_button: 'Explore Doppler',
    transfer_explore_message: 'While you wait, keep exploring everything your account has to offer...',
    transfer_pay_the_invoice_message: 'Make the payment.',
    transfer_purchase_finished_title: 'Your invoice is on the way',
    transfer_send_the_receipt_message: `After completing your payment, send your receipt to <Link>billing@fromdoppler.com</Link> and we'll activate your new Plan right away.`,
    transfer_send_the_receipt_not_upgrade_pending_message: 'Once you make the payment, send us the proof to <Link>billing@fromdoppler.com</Link> so we can identify it.',
    transfer_send_the_receipt_with_link_message: 'Send the payment proof by email to <Link>billing@fromdoppler.com</Link>, so we can activate your new Plan.',
    ...
    transfer_title: 'Complete the steps to finish your purchase',
    transfer_upgrade_title: 'Your new Plan is now active!',
    transfer_upgrade_warning_message: 'Complete your payment to keep your Plan active and continue enjoying all its benefits.',
    transfer_warning_message: 'Finish the payment process and start using your new Plan right away.',
  ...
  collaborators: {
    ...
    form_modal: {
      ...
      permissions_labels: {
        section_01: 'Reports',
        section_02: 'Campaigns',
        section_03: 'Lists',
        section_04: 'Control panel',
        section_05: 'Download center',
        section_08: 'Steps',
        section_10: 'Automation',
        section_11: 'Integrations',
        section_12: 'Templates',
        section_13: 'Approver',
...
Want to know more? Press [HELP](${urlHelp}/contact-policy).`,
    ...
    time_restriction: {
      ...
      time_slot_hint_text: 'keep this option disabled if you don’t want to limit sending to a specific time slot.',
      time_slot_hint_title: 'Important:',
...
<Paragraph><Bold><Link>Configure DKIM, SPF and DMARC</Link></Bold> so that your contacts receive your mailings successfully.</Paragraph>
  ...
  faq: {
    answer_1: `**International credit card** Visa, Mastercard or American Express; **bank transfer** (for Argentina, Mexico and Colombia clients); **Automatic debit** (for Argentina)`,
    ...
    **Promo Codes are not accumulative with prepayment discounts.**`,
    ...
    question_8: `What happens if I don't use all the Emails I have hired per month?`,
...
You'll find an Email with steps to follow.`,
  ...
  integrations: {
    ...
    native_integrations: {
      ...
      siigo_title: 'Siigo',
      tiendanegocio_title: 'Tienda Negocio',
  ...
  landing_selection: {
    addon_promotion_all_plans_message: '{br}● <bold>{discount}% discount</bold> for all <bold>Packs</bold>.',
    addon_promotion_one_plan_message: '{br}● <bold>{discount}% discount</bold> in the <bold>Pack of {quantity}</bold>.',
    addon_promotion_title: 'Remember that you have a:',
  ...
  login: {
    ...
    enter_doppler_sub: `Your Campaigns are waiting for you. Log in and keep growing your business.`,
    ...
    subscription_details: {
      ...
      addon: {
        ...
        onsite_plan: {
          ...
          addon_promotion_all_plans_message: `{br}● <bold>{discount}% discount</bold> for the all <bold>Plans</bold>.
          {expirationDate, select, null {} other { Valid until <bold>{expirationDate}</bold>.}}`,
          addon_promotion_one_plan_message: `{br}● <bold>{discount}% discount</bold> on the <bold>Plan for {quantity} impressions</bold>.
          {expirationDate, select, null {} other { Valid until <bold>{expirationDate}</bold>.}}`,
          addon_promotion_title: 'Remember that you have a:',
        ...
        push_notification_plan: {
          ...
          addon_promotion_all_plans_message: `{br}● <bold>{discount}% discount</bold> for the all <bold>Plans</bold>.
          {expirationDate, select, null {} other { Valid until <bold>{expirationDate}</bold>.}}`,
          addon_promotion_one_plan_message: `{br}● <bold>{discount}% discount</bold> on the <bold>Plan for {quantity} emails</bold>.
          {expirationDate, select, null {} other { Valid until <bold>{expirationDate}</bold>.}}`,
          addon_promotion_title: 'Remember that you have a:',
...
Promo code isn’t valid.`,
  ...
  push_notification_section: {
    panel: {
      ...
      change_plan: 'UPDATE YOUR PLAN',
      consume_state_title: 'State of Consumption',
      consumed_sends: 'Consumed:  **{quantity} Shipments**',
      countdown_message_plural: 'You have **{days} days** left to complete your trial period for Doppler Push Notifications.',
      countdown_message_singular: 'You have **{days} day** left to complete your trial period for Doppler Push Notifications.',
      date_expiration_error: 'Your trial has ended! Activate a Plan to continue reaching your customers with effective Push Notifications.',
      description: 'You can now see how many messages you have left and easily manage them from here.',
      description1: 'Start using this Add-on and turn your visitors into customers with effective and segmented messages.\n\n Follow these steps:',
      description2: `1. Click on the **'Configure'** button..\n2. Verify your website domain in the **'On-site Tracking and Push Notifications'** section.\n3. Enable **Push Notifications**.`,
      exceeded: 'You have reached the maximum number of messages allowed by your Plan. ',
      exceeded2: `Notifications are still active for any **excess messages**. If you don't want to receive them, simply pause your messages.`,
      exceeded_sends: 'Exceeded sends: ',
      purchase_plan: 'PURCHASE YOUR PLAN',
      sends: '{quantity} Shipments',
      sends_month: '{quantity} Shipments / month',
      sends_option: 'Sending options',
      sends_option_pause: 'Push Notification Control',
      sends_option_pause_description: 'If you deactivate this **Add-on**, your Push Notifications will be temporarily paused. When you reactivate it, sending **will resume automatically**.',
...
and create Abandoned Cart and Retargeting Product Automations. Any questions? Press [HELP](${urlHelp}/how-to-integrate-doppler-with-shopify/).`,
  ...
  signup: {
    ...
    create_account_title: `CREATE YOUR FREE ACCOUNT`,
...
deletion, security, cross-border data transfers and other issues.
  `,
    ...
    sign_up_sub: `Boost your Multichannel Marketing with Doppler.{br}Send unlimited Emails to 500 Contacts for 90 days.
Includes full access to Doppler Academy.{br}Already have an account? <Link>Log in</Link>`,
