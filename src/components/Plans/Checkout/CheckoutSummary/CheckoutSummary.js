      ...
      <AddOn
        ...
        priceComponent={
          <>
            ...
            US${cheapestLandingPack?.price || 0}*
          </>
        }
      />
    );
    ...
    return (
      <>
        ...
        <section className="dp-container">
          ...
          {isBuyMarketingPlan && <ModalPromoLandingPacks />}
        </section>
      </>
    );
  },
    ...
    <div className="modal" id="modal-medium">
      <div className="modal-content--medium">
        <div className="dp-modal-pack-landing">
          ...
          <p>Lorem ipsum dolor sit amet consectetur. Ac eleifend diam lobortis montes.</p>
