...
const PlusAccount: React.FunctionComponent<IPlusAccountProps> = (props) => {
    ...
    const onClickHandler = useCallback((isSaved: boolean)=>{
      if (isSaved){
        setMessage(isSaved);
        setSaved(isSaved);
      }else{
    ...
    const onClickBtnHandler = useCallback((btn: string)=>{
      setMessage(true);
      setSaved(false);
    },[setMessage, setSaved]); 
          ...
          <div className="dp-rowflex">
            <div className="col-sm-12 col-md-12 col-lg-12">
              <nav className="dp-breadcrumb">
                <ul>
                  <li>
                    <a href={i18('big_query.url_legacy_doppler')}>{i18('big_query.plus_beginning')}</a>
                  </li>
                  <li>
                    <a href={i18('big_query.url_legacy_control_panel')}>{i18('big_query.plus_configuration')}</a>
                  </li>
                  <li>
                    <a href={i18('big_query.url_legacy_control_panel')}>{i18('big_query.plus_control_panel')}</a>
                  </li>
        ...
        <div className="dp-rowflex">
            <div className="col-lg-5">
                <div>
                  ...
                  <strong><FormattedMessageMarkdown id="big_query.plus_body_step_one_HD" /></strong>
            ...
            <div className="col-lg-5">
              <div>
                  ...
                  <strong><FormattedMessageMarkdown id="big_query.plus_body_step_two_HD" /></strong>
                  <p className="p-t-36">{i18('big_query.plus_step_two_paragraph')}</p>
                </div>
                <div className="p-t-54">
                  <img src={datastudiogif} alt={i18('big_query.free_alt_image')} width="500" height="300" />
                </div>
            </div>
        </div>
