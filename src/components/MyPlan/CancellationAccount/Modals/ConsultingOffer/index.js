    ...
    return (
        <div className="modal" id="modal-pre-cancellation-subscription">
            <div className="modal-content--small">
                <button type="button" className="dp-arrow-back" onClick={closePopup}>
                </button>
                ...
                <button type="button" className="dp-button button-medium primary-green dp-w-100 m-b-18 m-t-12" onClick={requestAdvice}>
                    {_('my_plan.cancellation.consulting_offer.request_advice_button')}
                </button>
                <a href="#" className="dp-link-cancellation m-b-24" onClick={continueWithCancellation}>
