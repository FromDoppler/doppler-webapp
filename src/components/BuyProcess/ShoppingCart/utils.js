...
export const mapItemFromLandingPackages = ({
  ...
  const LandingPackInformation = {
    ...
    featureList: [
      ...landingPacks.map(
        (landingPack) =>
          `${landingPack.packagesQty} packs de ${landingPack.landingsQty} landings c/u`,
      ),
    ],
    data: landingPacks,
    billingList: [],
    isRemovible: !!handleRemoveLandingPacks,
    handleRemove: handleRemoveLandingPacks,
  };
